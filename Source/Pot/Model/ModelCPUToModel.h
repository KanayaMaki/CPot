...
public:
	static void Load(StaticMeshModel& aMesh, const String<128> aFilePath, const VectorSimple<StaticMeshVertex>& aVertex, const VectorSimple<u32>& aIndex, const VectorSimple<SubMeshCPU>& aSubMesh, BOOL aVertexBufferWritable) {
	...
	static void Load(StaticMeshModel& aMesh, const String<128> aFilePath, const VectorSimple<StaticMeshVertex>& aVertex, const VectorSimple<u32>& aIndex, const VectorSimple<SubMeshCPU>& aSubMesh) {
